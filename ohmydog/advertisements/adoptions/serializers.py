...
from ohmydog.advertisements.adoptions.models import AdoptionAd
...
class AdoptionAdContactSerializer(serializers.ModelSerializer):
    ...
    def update(self, instance: AdoptionAd, validated_data):
        send_mail(
            _('Le avisamos al anunciante que quieres ponerte en contacto con el por su anuncio de adopcion en Oh my dog!'),
