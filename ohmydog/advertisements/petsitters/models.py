...
class PetSitterAd(AbstractAd):
    ...
    sitter_phone_number = models.CharField(max_length=32, null=False)
    service_type = models.CharField(max_length=16, choices=constants.SERVICE_TYPE_CHOICES, null=False)
    service_area = models.CharField(max_length=128, null=False)
